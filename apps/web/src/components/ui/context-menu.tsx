        ...
        <ContextMenuPrimitive.Portal>
            <ContextMenuPrimitive.Positioner className="isolate z-50">
                <ContextMenuPrimitive.Popup
                    ...
                    className={cn(
                        'data-closed:fade-out-0 data-closed:zoom-out-95 data-open:fade-in-0 data-open:zoom-in-95 z-50 min-w-32 origin-(--transform-origin) overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md data-closed:animate-out data-open:animate-in',
                        className,
                    )}
                    {...props}
                />
